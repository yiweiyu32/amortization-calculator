...
def find_first_payment(principal: float, annual_interest_rate: float, term: int,
    ...
    def get_ending_balance_n_last_payment(scheduled_monthly_payment):
    ...
    amortization_schedule, loan_metrics_current = get_ending_balance_n_last_payment(first_payment)
    _, loan_metrics_prime = get_ending_balance_n_last_payment(first_payment - one_cent)

    ending_balance = loan_metrics_current.get("Ending_Balance")
    last_payment = loan_metrics_current.get("Last_Payment")
